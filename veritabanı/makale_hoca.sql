...
CREATE TABLE `hoca` (
  ...
  `hocaad` varchar(45) DEFAULT NULL,
  `hocasoyad` varchar(45) DEFAULT NULL,
...
INSERT INTO `hoca` VALUES (3,'on','dsds','a','1q2w3eE','tarih','34','a@gmal.com'),(6,'sibel','sarýbas','b','b','Yapay Zeka','0','b@gmail.com'),(7,'c','c','c','c','Yapay Zeka','0','c@gmail.com');
