...
makaleislem.IdAldim(makaleveri);
 if (sonuc=true)
 {
    ...
    <form action="ymakaleguncelleview.jsp" method="post">
        <input id="baslik" placeholder= "Makale Başlığı" name="baslik" required value="<%=rs.getString("baslik") %>" />
        <textarea id="icerik" name="icerik" placeholder="İçergi yazınız..."> <%=rs.getString("icerik") %> </textarea>
