...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-container w3-light-grey w3-padding-32 w3-padding-large" id="contact">
    ...
    ResultSet rs = islem.bekleyenmakale(veri);
    while(rs.next()){ %>
      <form action="makaleonayla.jsp">
        ...
        <button type="submit" class="w3-button w3-block w3-black w3-margin-bottom">MAKALEYI ONAYLA</button>

      </form>
      <form  action="makalered.jsp" method="post">
           <br>
             <div class="submit">
                <input type="text" name="id" id="id" value="<%=rs.getString("id") %>" style="display:none;">
       <button type="submit" value="SiL" align= "center"class="button button5">IPTAL ET</button>
       </div>
 </form>
   <%}%>
    </div>
