...
<jsp:useBean id="datam" class="kategori.baglanti" scope="page"></jsp:useBean>
<jsp:useBean id="veri" class="hocakayit.getset" scope="page" ></jsp:useBean>
    <form action="hocakayitislemleri.jsp" class="form" >
      <h1>KAYIT EKRANI</h1>
      <div class="form-group">
        <input type="text" placeholder=" " name="hocaad" id="hocaad" required>
        <label for="hocaad">AD</label>
        <div class="error">
      ...
      <div class="form-group">
        <input type="text" placeholder=" " name="hocasoyad" id="hocasoyad" required>
        <label for="hocasoyad">SOYAD</label>
        <div class="error">
          <i class="fas fa-exclamation-circle"></i>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="error">
          <i class="fas fa-exclamation-circle"></i>
           ...
           <div class="form-group">
             <select  id="kategori" name="kategori" face="tahoma" style="width:350px ; height: 40px;"">
     <% 
  ResultSet tr=datam.selectAllData();
  while(tr.next()) { %>
    <option value="<%=tr.getString("kategori") %>" ><%=tr.getString("kategori") %></option>
