...
<jsp:useBean id="veri" class="kategori.getset" scope="page" ></jsp:useBean>
         <form  action="makaleekleview.jsp" method="post">
        <input name="baslik" id="baslik" placeholder= "Makale Başlığı"/>
        <textarea  name= "icerik" id="icerik" placeholder="İçergi yazınız..."></textarea>
    <div class="live">
        <h2></h2>
        <p></p>
